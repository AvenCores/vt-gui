...
def build_results_view(current_scan_results, selected_target_file, last_completed_sha256, lang, page):
    ...
    def handle_vote(verdict):
        def vote_action(e):
            ...
            def worker():
                try:
                    vote_item("files", last_completed_sha256, verdict, api_key)
    ...
    actions_row = ft.Row([
        ...
        ft.IconButton(ft.Icons.THUMBS_UP_DOWN_ROUNDED, icon_color="#39FF14", tooltip=STRINGS[lang].get("vote_harmless", "Vote Harmless"), on_click=handle_vote("harmless")),
        ft.IconButton(ft.Icons.THUMB_DOWN_ALT_ROUNDED, icon_color="#FF3131", tooltip=STRINGS[lang].get("vote_malicious", "Vote Malicious"), on_click=handle_vote("malicious"))
