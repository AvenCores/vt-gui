...
STRINGS = {
    "en": {
        ...
        "context_menu_success": "Context menu registered successfully!",
        "context_menu_removed": "Context menu removed successfully!",
        "context_menu_fail": "Failed to modify context menu: {e}",
    ...
    "ru": {
        ...
        "context_menu_success": "Пункт успешно добавлен в контекстное меню!",
        "context_menu_removed": "Пункт успешно удален из контекстного меню!",
        "context_menu_fail": "Не удалось изменить меню: {e}",
